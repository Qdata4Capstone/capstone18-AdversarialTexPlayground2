...
from webapp.models import l0_model, linf_model, dm_model
...
@app.route('/dm')
def dm():
  return render_template('deepmotif.html',
      title='DeepMotif Text Sequence',
      model_name="dm",)
...
def run_adversary():
  ...
  if model_name == 'dm':
    #print('Deep motif!!!')
    ret_val = {
              'adversary_class':"text classification",
              'original_text_data': ["hi my name is bob"],
              'adv_text_data': ["ih my naem is bbo"],
            }
