...
import argparse
from webapp.models import loaddata
from webapp.models import dataloader
from webapp.models import model
from webapp.models import scoring
from webapp.models import scoring_char
from webapp.models import transformer
from webapp.models import transformer_char
import numpy as np
import pickle
np.random.seed(7)
