...
from webapp.models.preprocessing import Tokenizer, pad_sequences
...
def loaddata(i = 0):
    ...
    lines = [3] #[3,3,3,3,3,4,2,2,2]
    classes= [4] #[4,5,2,14,5,10,5,2,2]
...
if __name__ == "__main__":
    (traindata,testdata,numclass) = loaddata(0) #loaddata(8)
